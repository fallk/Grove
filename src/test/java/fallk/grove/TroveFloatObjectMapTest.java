...
//float
public class TroveFloatObjectMapTest {
    ...
    @Test
    public void test() {
        Gson gson = new GsonBuilder().registerTypeAdapter(new TypeToken<TFloatObjectMap>(){}.getType(), new TroveFloatObjectMapTypeAdapter<>()).create();
