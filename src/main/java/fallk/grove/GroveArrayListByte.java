...
final class GroveArrayListByte implements JsonSerializer<TByteArrayList>, JsonDeserializer<TByteArrayList> {
    public static final GroveArrayListByte INSTANCE = new GroveArrayListByte();
    private GroveArrayListByte() {}
